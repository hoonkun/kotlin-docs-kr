...
### 문서 내 문단 링크의 원문 존중 및 링크 편의성
가능하면 실제 kotlinlang.org 의 문서에서 도메인만 kotlin-docs-kr.hoonkun.kiwi 로 바꾸었을 때, 
문단을 포함하여 번역된 것이 있었다면 연결이 되었으면 합니다.  

이는 설계상 가능할 것으로 보이기 때문에 조만간 추가할 것 같습니다.
